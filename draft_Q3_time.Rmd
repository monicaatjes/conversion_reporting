...
```{r trend cus mo ro, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr mo ro, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr mo ro cus, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr mo ro t, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus s ro, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr s ro, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr s ro cus, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr s ro t, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus ip ro, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr ip ro, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr ip ro cus, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr ip ro t, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus ul ro, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}

trend_overview <- data_tot %>%
  dplyr::select(quarter, Category, Product, rank_order, country, Device, NewvsCurrent,  `Product page`) %>%
  dplyr::filter(Category=="Unsecured lending", 
                country=="Romania", 
                Product =="ING Personal") %>%
  dplyr::select(quarter, Device, NewvsCurrent,  `Product page`)
trend_plot1 <- trend_plot_format_function(trend_overview) 
trend_plot1
...
```{r tr ul ro, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr ul ro cus, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr ul ro t, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus ca BE, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr ca be, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr ca be cus, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
trend_overview <- data_tot %>%
  dplyr::select(quarter, Category, Product, rank_order, country, Device, NewvsCurrent,  `Product page`) %>%
  dplyr::filter(Category=="Current accounts", 
                country=="Belgium", 
...
```{r tr ca be t, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus s BE, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr s be, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr s be cus, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
trend_overview <- data_tot %>%
  dplyr::select(quarter, Category, Product, rank_order, country, Device, NewvsCurrent,  `Product page`) %>%
  dplyr::filter(Category=="Savings", 
                country=="Belgium", 
...
```{r tr s be t, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus ip BE, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr ip be, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr ip be cus, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
trend_overview <- data_tot %>%
  dplyr::select(quarter, Category, Product, rank_order, country, Device, NewvsCurrent,  `Product page`) %>%
  dplyr::filter(Category=="Investment products", 
                country=="Belgium", 
...
```{r tr ip be t, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus ul BE, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr ul be, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr ul be cus, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
trend_overview <- data_tot %>%
  dplyr::select(quarter, Category, Product, rank_order, country, Device, NewvsCurrent,  `Product page`) %>%
  dplyr::filter(Category=="Unsecured lending", 
                country=="Belgium", 
...
```{r tr ul be t, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus in BE, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr in be, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr in be cus, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
trend_overview <- data_tot %>%
  dplyr::select(quarter, Category, Product, rank_order, country, Device, NewvsCurrent,  `Product page`) %>%
  dplyr::filter(Category=="Insurances", 
                country=="Belgium", 
...
```{r tr in be t, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus m aus, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr mo aus, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr au n2b, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
trend_overview <- data_tot %>%
  dplyr::select(quarter, Category, Product, rank_order, country, Device, NewvsCurrent,  `Product page`) %>%
  dplyr::filter(Category=="Mortgages", 
                country=="Australia", 
...
```{r tr aus  t, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus ca aus, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr ca aus, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr aus n2b, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
trend_overview <- data_tot %>%
  dplyr::select(quarter, Category, Product, rank_order, country, Device, NewvsCurrent,  `Product page`) %>%
  dplyr::filter(Category=="Current accounts", 
                country=="Australia", 
...
```{r tr aus  te, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus s aus, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr s aus, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr au s n2b, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
trend_overview <- data_tot %>%
  dplyr::select(quarter, Category, Product, rank_order, country, Device, NewvsCurrent,  `Product page`) %>%
  dplyr::filter(Category=="Savings", 
                country=="Australia", 
...
```{r tr aus  s, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus ip aus, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr ip aus, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr ip au n2b, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
trend_overview <- data_tot %>%
  dplyr::select(quarter, Category, Product, rank_order, country, Device, NewvsCurrent,  `Product page`) %>%
  dplyr::filter(Category=="Investment products", 
                country=="Australia", 
...
```{r tr aus ip te, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus ul aus, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr ul aus, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr ul au n2b, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
trend_overview <- data_tot %>%
  dplyr::select(quarter, Category, Product, rank_order, country, Device, NewvsCurrent,  `Product page`) %>%
  dplyr::filter(Category=="Unsecured lending", 
                country=="Australia", 
...
```{r tr aus ul te, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r trend cus ins aus, echo=FALSE, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
...
```{r tr ins aus, echo=FALSE, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align ="left"}
...
```{r tr ins au n2b, echo=FALSE, echo=F, eval=T, fig.width=3.5, fig.height=3.5, warning=F, message=F, fig.align="left"}
trend_overview <- data_tot %>%
  dplyr::select(quarter, Category, Product, rank_order, country, Device, NewvsCurrent,  `Product page`) %>%
  dplyr::filter(Category=="Insurances", 
                country=="Australia", 
...
```{r tr aus in te, echo=FALSE, echo=FALSE, echo=F, eval=T, fig.width=3, fig.height=3.5, warning=F, message=F, fig.align="left"}
